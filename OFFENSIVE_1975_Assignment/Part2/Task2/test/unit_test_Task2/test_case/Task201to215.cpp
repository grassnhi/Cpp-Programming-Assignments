...
bool UNIT_TEST_Task2::Task208()
{
    ...
    */
    ...
    EXP = 72 + 130 = 202
    */
    cout << "Attacker: " << attacker->getLF() << - attacker->getEXP() << endl;
    ...
    */
    ...
    EXP = 15 + 225 = 240
    */
    cout << "Enemy: " << enemy->getLF() << - enemy->getEXP() << endl;
...
bool UNIT_TEST_Task2::Task212()
{
    ...
    while (current != nullptr) {
        int debug = current->unit->getAttackScore();

        if (current->unit->isVehicle()) {
            cout << i << ": [Vehicle] " << debug << endl;
        } else {
            cout << i << ": [Infantry] " << debug << endl;
        }
